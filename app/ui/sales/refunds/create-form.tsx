...
import {
  ...
  TagIcon,
  ScaleIcon,
  GlobeAltIcon, HashtagIcon, IdentificationIcon, InboxIcon
        ...
        <div className="rounded-md bg-gray-50 p-4 md:p-6">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                  ...
                  name="date"
                  type="date"
                  placeholder="Enter Date of Refund"
                  className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm"
              />
              <CalendarIcon
                  className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900"
          ...
          <div className="mt-6 flex justify-end gap-4">
            <Link href="/dashboard/sales"
                  className="flex h-10 items-center rounded-lg bg-gray-100 px-4 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-200">Cancel</Link>
